  ...
  return (
    <div className='App'>
        ...
        : <><div className="greet">
          ...
          <span className=''>Your Single Source of Truth.</span>
        </div>
        <div className="suggestion">
          <button className='sgBtn' onClick={()=>setInput("Can you explain what VOOMA is and how it works?")}>
          <span className='sgTxt'>Can you explain what VOOMA is and how it works?</span>
          <img className='sgImg' src={assets.bulb_icon} alt="" />
          </button>
          <button className='sgBtn' onClick={()=>setInput("What are the requirements to join VOOMA, and is there any documentation needed?")}>
          <span className='sgTxt'>What are the requirements to join VOOMA, and is there any documentation needed?</span>
          <img className='sgImg' src={assets.compass_icon} alt="" />
          </button>
          <button className='sgBtn' onClick={()=>setInput("Could you guide me through the process of registering for VOOMA?")}>
          <span className='sgTxt'>Could you guide me through the process of registering for VOOMA?</span>
          <img className='sgImg' src={assets.message_icon} alt="" />
          </button>
          <button className='sgBtn' onClick={()=>setInput("What are all the services and features available through VOOMA?")}>
          <span className='sgTxt'>What are all the services and features available through VOOMA?</span>
      ...
      <div className="Search">
        <input type="text"
          ...
          placeholder='Ask me any Vooma question(for Now)' className="searchBar"  />
